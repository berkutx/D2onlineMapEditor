...
export const EDIT_TOOLS: ToolDef[] = [
  { value: "select", label: "Обзор", icon: Pointer, hint: "ЛКМ — осмотр · колесо — масштаб · тащить — двигать карту" },
  ...
  { value: "move", label: "Двигать", icon: Rank, hint: "клик — взять · клик — поставить · R — облик · Esc — отмена" },
];
